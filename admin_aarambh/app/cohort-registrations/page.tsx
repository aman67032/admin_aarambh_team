  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-text-muted mt-1">Live student confirmation status across all clusters and cohorts.</p>
      </div>
          ...
          {[
            ...
            <div key={stat.label} className="bg-white border border-card-border rounded-2xl p-4 flex items-start gap-3 shadow-sm">
              ...
              <div>
                ...
                <div className="text-[11px] text-text-muted font-semibold mt-1.5">{stat.label}</div>
              </div>
            </div>
          ))}
        </div>
          ...
          <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
            ...
            <div className="relative flex-1 sm:flex-none">
              ...
              <input
                ...
                className="pl-9 pr-8 py-2 bg-white border border-card-border rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-primary/30 text-foreground w-full sm:w-60 shadow-sm"
              />
              {searchTerm && (
          ...
          {activeView === 'leaderboard' ? (
            ...
            <div className="space-y-3">
              <div className="bg-white border border-card-border rounded-2xl overflow-hidden shadow-sm">
                <div className="px-4 sm:px-5 py-3.5 border-b border-card-border bg-card-bg/50 grid grid-cols-10 sm:grid-cols-12 text-[10px] font-bold text-text-muted uppercase tracking-widest">
                  <span className="col-span-1 text-center">Rank</span>
                  <span className="col-span-5">Cohort · Leader</span>
                  <span className="hidden sm:block col-span-2 text-center">Cluster</span>
                ...
                <div className="divide-y divide-card-border">
                  {cohortsRanked.map((c, idx) => {
                    ...
                    return (
                      <div
                        key={c.cohortName}
                        className={`grid grid-cols-10 sm:grid-cols-12 items-center px-4 sm:px-5 py-3.5 text-sm transition-colors ${
