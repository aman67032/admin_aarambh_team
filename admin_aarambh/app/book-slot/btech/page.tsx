...
const COURSE = 'B.Tech';
const COURSE_COLOR = '#6366f1'; // Indigo
          ...
          <div className="glass-card p-6 sm:p-8 space-y-6 max-w-lg mx-auto">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-background border border-card-border rounded-xl text-sm text-foreground placeholder:text-text-muted/50 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all"
              />
            </div>
            <div className="space-y-1.5">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-xs font-bold border transition-all cursor-pointer ${
                    selectedDate === d
                      ...
                      : 'bg-card-bg border-card-border text-text-muted hover:border-indigo-500/50'
                  }`}
                >
                      ...
                      <button
                        ...
                        className={`p-3 rounded-xl border text-center transition-all cursor-pointer ${
                          selectedSlot === slot.time
                            ? `bg-gradient-to-r ${COURSE_GRADIENT} text-white border-transparent shadow-lg shadow-indigo-500/20`
                            : getSlotColor(slot)
                        }`}
                      >
