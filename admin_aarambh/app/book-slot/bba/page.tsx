...
const COURSE = 'BBA';
const COURSE_GRADIENT = 'from-amber-500 to-orange-600';
const COURSE_GLOW = 'shadow-amber-500/25';
const COURSE_RING = 'focus:ring-amber-500/30';
const COURSE_BORDER = 'focus:border-amber-500';
const MAX_DESKS = 2;
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12 flex-1 w-full relative z-10">
          ...
          <div className="flex items-center justify-between relative">
            ...
            <div className="z-10 flex flex-col items-center">
              ...
              <span className={`text-[10px] font-bold mt-1.5 uppercase tracking-wider ${
                step === 'form' ? 'text-amber-500' : 'text-text-muted'
              }`}>Verify</span>
            </div>
            ...
            <div className="z-10 flex flex-col items-center">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 ${
                step === 'slots' 
                  ? 'bg-amber-500 text-white ring-4 ring-amber-500/20' 
                  : step === 'confirmed' ? 'bg-amber-500 text-white' : 'bg-card-bg border border-card-border/80 text-text-muted'
              }`}>
                {step === 'confirmed' ? '✓' : '2'}
              </div>
              <span className={`text-[10px] font-bold mt-1.5 uppercase tracking-wider ${
                step === 'slots' ? 'text-amber-500' : 'text-text-muted'
              }`}>Pick Slot</span>
            </div>
            ...
            <div className="z-10 flex flex-col items-center">
              ...
              <span className={`text-[10px] font-bold mt-1.5 uppercase tracking-wider ${
                step === 'confirmed' ? 'text-amber-500' : 'text-text-muted'
              }`}>Confirm</span>
            </div>
          </div>
        </div>
        ...
        {step === 'form' && (
          <div className="glass-card p-6 sm:p-8 space-y-6 max-w-lg mx-auto animate-float-subtle">
            ...
            {error && (
              <div className="text-xs text-red-500 dark:text-red-400 font-bold bg-red-500/10 border border-red-500/20 rounded-xl px-4 py-3">
                ⚠️ {error}
              </div>
            )}
        ...
        {step === 'slots' && (
          <div className="space-y-6 max-w-xl mx-auto">
                ...
                <button
                  ...
                  className={`px-5 py-2.5 rounded-full text-xs font-bold border transition-all duration-300 cursor-pointer ${
                    selectedDate === d
                      ...
                      : 'bg-card-bg border-card-border/60 text-text-muted hover:border-amber-500/50 hover:bg-amber-500/5'
                  }`}
                >
            ...
            <div className="text-center bg-card-bg/40 border border-card-border/40 py-2.5 px-4 rounded-full max-w-sm mx-auto text-xs text-text-muted font-bold tracking-wide">
                            ...
                            isSelected
                              ...
                              : isFull
                                ...
                                : isLow
                                  ...
                                  : 'bg-card-bg border-card-border text-foreground hover:border-amber-500 hover:bg-amber-500/5 hover:text-amber-600 dark:hover:text-amber-400 hover:-translate-y-0.5'
                          }`}
                        >
        ...
        {step === 'confirmed' && booking && (
          <div className="glass-card p-6 sm:p-8 space-y-6 max-w-lg mx-auto text-center border-2 border-amber-500/20 relative overflow-hidden animate-float-subtle">
            ...
            <div className="bg-amber-500/10 border border-amber-500/25 rounded-2xl p-4 text-[11px] text-amber-600 dark:text-amber-400 font-semibold leading-relaxed">
              ⚠️ **Important Note:** Please report at **Desk {booking.deskNumber}** exactly 5 minutes before your time slot. Make sure to carry all your original academic & confirmation documents.
            </div>
          </div>
        )}
