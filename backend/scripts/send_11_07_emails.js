...
const TARGET_APP_NOS = new Set([
  "JKLU/B.TECH/2026/0300",
  "JKLU/B.TECH/2026/0579",
  "JKLU/B.TECH/2026/0734",
  "JKLU/B.TECH/2026/0787",
  "JKLU/B.TECH/2026/0960",
  "JKLU/B.TECH/2026/1088",
  "JKLU/B.TECH/2026/1230",
  "JKLU/B.TECH/2026/1832",
  "JKLU/B.TECH/2026/1868",
  "JKLU/B.TECH/2026/1882",
  "JKLU/B.TECH/2026/2023",
  "JKLU/B.TECH/2026/2046",
  "JKLU/B.TECH/2026/2208",
  "JKLU/B.TECH/2026/2650",
  "JKLU/B.TECH/2026/2691",
  "JKLU/BBA/2026/0129",
  "JKLU/BBA/2026/0243",
  "JKLU/BBA/2026/0288",
  "JKLU/BBA/2026/0323",
...
async function main() {
  ...
  try {
    ...
    // 3. Find students in database by application number
    ...
    console.log(`\n=== Verification Status ===`);
    console.log(`Total target students in database: ${studentsToEmail.length}`);
    console.log('===========================\n');
    ...
    if (!isLive) {
      console.log('DRY RUN: Showing details of the 21 new students from the July 11th sheet to receive emails:');
      studentsToEmail.forEach((student, idx) => {
      ...
      console.log('  node scripts/send_11_07_emails.js --live\n');
      return;
    }

    console.log(`STARTING LIVE EMAIL CAMPAIGN FOR 21 NEW STUDENTS...\n`);
